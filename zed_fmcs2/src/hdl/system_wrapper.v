...
module system_wrapper
  ...
  inout [1:0]iic_mux_scl_io;
  inout [1:0]iic_mux_sda_io;
  input otg_vbusoc;
  input rx_clk_in_n;
  input rx_clk_in_p;
  ...
  wire iic_fmc_sda_o;
  wire iic_fmc_sda_t;
  wire [0:0]iic_mux_scl_i_0;
  wire [1:1]iic_mux_scl_i_1;
  wire [0:0]iic_mux_scl_io_0;
  wire [1:1]iic_mux_scl_io_1;
  wire [0:0]iic_mux_scl_o_0;
  wire [1:1]iic_mux_scl_o_1;
  wire iic_mux_scl_t;
  wire [0:0]iic_mux_sda_i_0;
  wire [1:1]iic_mux_sda_i_1;
  wire [0:0]iic_mux_sda_io_0;
  wire [1:1]iic_mux_sda_io_1;
  wire [0:0]iic_mux_sda_o_0;
  wire [1:1]iic_mux_sda_o_1;
  wire iic_mux_sda_t;
  wire otg_vbusoc;
  wire rx_clk_in_n;
  wire rx_clk_in_p;
  ...
  IOBUF iic_fmc_sda_iobuf
       (.I(iic_fmc_sda_o),
        ...
        .O(iic_fmc_sda_i),
        .T(iic_fmc_sda_t));
  IOBUF iic_mux_scl_iobuf_0
       (.I(iic_mux_scl_o_0),
        .IO(iic_mux_scl_io[0]),
        .O(iic_mux_scl_i_0),
        .T(iic_mux_scl_t));
  IOBUF iic_mux_scl_iobuf_1
       (.I(iic_mux_scl_o_1),
        .IO(iic_mux_scl_io[1]),
        .O(iic_mux_scl_i_1),
        .T(iic_mux_scl_t));
  IOBUF iic_mux_sda_iobuf_0
       (.I(iic_mux_sda_o_0),
        .IO(iic_mux_sda_io[0]),
        .O(iic_mux_sda_i_0),
        .T(iic_mux_sda_t));
  IOBUF iic_mux_sda_iobuf_1
       (.I(iic_mux_sda_o_1),
        .IO(iic_mux_sda_io[1]),
        .O(iic_mux_sda_i_1),
        .T(iic_mux_sda_t));
  system system_i
       (.ddr_addr(ddr_addr),
        ...
        .iic_mux_scl_i({iic_mux_scl_i_1,iic_mux_scl_i_0}),
        .iic_mux_scl_o({iic_mux_scl_o_1,iic_mux_scl_o_0}),
        .iic_mux_scl_t(iic_mux_scl_t),
        .iic_mux_sda_i({iic_mux_sda_i_1,iic_mux_sda_i_0}),
        .iic_mux_sda_o({iic_mux_sda_o_1,iic_mux_sda_o_0}),
