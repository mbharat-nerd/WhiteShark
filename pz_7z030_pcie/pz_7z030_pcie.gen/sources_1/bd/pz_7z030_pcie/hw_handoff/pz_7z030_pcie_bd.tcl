...
################################################################
# This is a generated script based on design: pz_7z030_pcie
#
...
# source pz_7z030_pcie_script.tcl
...
0#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#GPIO#UART 1#UART 1#GPIO#GPIO#Enet 0#Enet 0}\
  ...
  connect_bd_intf_net -intf_net mem_intercon_M00_AXI [get_bd_intf_pins mem_intercon/M00_AXI] [get_bd_intf_pins processing_system7_0/S_AXI_HP0]
  ...
  connect_bd_intf_net -intf_net processing_system7_0_M_AXI_GP0 [get_bd_intf_pins periph_intercon_0/S00_AXI] [get_bd_intf_pins processing_system7_0/M_AXI_GP0]
  connect_bd_intf_net -intf_net processing_system7_0_M_AXI_GP1 [get_bd_intf_pins periph_intercon_1/S00_AXI] [get_bd_intf_pins processing_system7_0/M_AXI_GP1]
  ...
  connect_bd_net -net axi_pcie_0_axi_ctl_aclk_out [get_bd_pins axi_pcie_0/axi_ctl_aclk_out] [get_bd_pins periph_intercon_0/M00_ACLK] [get_bd_pins proc_sys_reset_0/slowest_sync_clk]
  connect_bd_net -net axi_pcie_0_interrupt_out [get_bd_pins axi_pcie_0/interrupt_out] [get_bd_pins xlconcat_0/In0]
  connect_bd_net -net axi_pcie_0_mmcm_lock [get_bd_ports mmcm_lock] [get_bd_pins axi_pcie_0/mmcm_lock] [get_bd_pins proc_sys_reset_0/dcm_locked]
  connect_bd_net -net perst_n_1 [get_bd_ports perst_n] [get_bd_pins axi_pcie_0/axi_aresetn] [get_bd_pins proc_sys_reset_0/ext_reset_in]
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins mem_intercon/S00_ARESETN] [get_bd_pins periph_intercon_0/M00_ARESETN] [get_bd_pins periph_intercon_1/M00_ARESETN] [get_bd_pins proc_sys_reset_0/peripheral_aresetn]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins mem_intercon/ACLK] [get_bd_pins mem_intercon/M00_ACLK] [get_bd_pins periph_intercon_0/ACLK] [get_bd_pins periph_intercon_0/S00_ACLK] [get_bd_pins periph_intercon_1/ACLK] [get_bd_pins periph_intercon_1/S00_ACLK] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/M_AXI_GP1_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
  ...
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins mem_intercon/ARESETN] [get_bd_pins mem_intercon/M00_ARESETN] [get_bd_pins periph_intercon_0/ARESETN] [get_bd_pins periph_intercon_0/S00_ARESETN] [get_bd_pins periph_intercon_1/ARESETN] [get_bd_pins periph_intercon_1/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]
  ...
  assign_bd_address -offset 0x80000000 -range 0x40000000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_pcie_0/S_AXI/BAR0] -force
  assign_bd_address -offset 0x40000000 -range 0x10000000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_pcie_0/S_AXI_CTL/CTL0] -force
